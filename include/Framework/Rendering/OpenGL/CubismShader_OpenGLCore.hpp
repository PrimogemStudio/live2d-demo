...
private:
    ...
    */
     ...
     */
    void SetVertexAttributes(const CubismModel& model, const csmInt32 index, const CubismShaderSet* shaderSet, GLuint pos, GLuint uv);
     ...
     * @param[in]   shaderSet             ->  シェーダープログラムのセット
     */
    void SetupTexture(CubismRenderer_OpenGLCore* renderer, const CubismModel& model, const csmInt32 index, CubismShaderSet* shaderSet);
     ...
     */
    void SetColorUniformVariables(CubismRenderer_OpenGLCore* renderer, const CubismModel& model, const csmInt32 index, CubismShaderSet* shaderSet,
     ...
     */
    void SetColorChannelUniformVariables(CubismShaderSet* shaderSet, CubismClippingContext_OpenGLCore* contextBuffer);
